package com.example.serralheria_server.security.configs;
...
public class SecurityConfig {
    ...
    private final com.example.serralheria_server.security.configs.JwtAuthenticationFilter filter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .hasRole("USER")
                .requestMatchers(HttpMethod.PUT, "/Servicos/Entrada/**")
                .hasRole("USER")
                .requestMatchers(HttpMethod.PUT, "/Servicos/PagamentoFinal/**")
                .hasRole("USER")
